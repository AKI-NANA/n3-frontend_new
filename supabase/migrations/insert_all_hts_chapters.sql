-- HTS Chapters 完全データ（全99章）
-- 公式のHTS分類に基づく正式なChapter説明
...
-- Section XIII: ARTICLES OF STONE, PLASTER, CEMENT (Chapters 68-70)
...
-- Section XVIII: OPTICAL, PHOTOGRAPHIC, CINEMATOGRAPHIC (Chapters 90-92)

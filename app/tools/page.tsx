...
import { getSortedNavigationItems, NavigationItem, SubMenuItem } from '@/components/layout/SidebarConfig'
      ...
      <div className="mt-12 p-6 bg-blue-50 rounded-lg">
        ...
        <ul className="space-y-2 text-gray-700">
          <li className="flex items-start gap-2">
            ...
            <span>新しいツールを追加する場合は、<code className="bg-white px-2 py-0.5 rounded">components/layout/SidebarConfig.ts</code>を編集してください</span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-blue-600 font-bold">●</span>

                ...
                <div class="section">
                    <div class="section-header">
                        ...
                        <div style="display: flex; gap: var(--space-sm);">
                            <button class="btn btn-success" onclick="processAllProductsWithHTML()">
                                <i class="fas fa-magic"></i> 全商品一括処理
                            </button>
                            <button class="btn btn-info" onclick="downloadHTMLUpdatedCSV()">
                                <i class="fas fa-download"></i> HTML統合CSV取得
                            </button>
                        </div>
                    </div>
                    ...
                    <div style="background: var(--bg-tertiary); padding: var(--space-lg); border-radius: var(--radius-lg); margin-bottom: var(--space-lg);">
                        <h4 style="margin-bottom: var(--space-md);">
                            <i class="fas fa-palette"></i> HTMLテンプレート管理
                        </h4>
                        ...
                        <div style="display: grid; grid-template-columns: 2fr 1fr; gap: var(--space-lg); margin-bottom: var(--space-md);">
                            <div>
                                <label style="display: block; margin-bottom: 0.5rem; font-weight: 600;">
                                    <i class="fas fa-upload"></i> HTMLテンプレートを作成・編集
                                </label>
                                <textarea 
...
<body>
    <h1>{{PRODUCT_TITLE}}</h1>
    <div>価格: {{PRICE_USD}}</div>
    <div>ブランド: {{BRAND_NAME}}</div>
    ...
    {{SHIPPING_INFO}}
                            ...
                            <div>
                                <label style="display: block; margin-bottom: 0.5rem; font-weight: 600;">
                                    <i class="fas fa-tags"></i> 差し込みワード（クリックで挿入）
                                </label>
                                <div style="background: var(--bg-secondary); border: 1px solid var(--border-color); border-radius: var(--radius-md); padding: var(--space-sm); max-height: 250px; overflow-y: auto;">
                                    <div style="margin-bottom: var(--space-sm);">
                                        <div style="font-weight: 600; font-size: 0.8rem; color: var(--primary-color); margin-bottom: 0.25rem;">基本情報</div>
                                        <div style="display: flex; flex-wrap: wrap; gap: 0.25rem;">
                                            <span class="variable-tag" onclick="insertVariable('{{PRODUCT_TITLE}}')">タイトル</span>
                                            <span class="variable-tag" onclick="insertVariable('{{PRICE_USD}}')">価格</span>
                                            <span class="variable-tag" onclick="insertVariable('{{BRAND_NAME}}')">ブランド</span>
                                        </div>
                                    </div>
                                    <div style="margin-bottom: var(--space-sm);">
                                        <div style="font-weight: 600; font-size: 0.8rem; color: var(--success-color); margin-bottom: 0.25rem;">画像</div>
                                        <div style="display: flex; flex-wrap: wrap; gap: 0.25rem;">
                                            <span class="variable-tag" onclick="insertVariable('{{IMAGE_GALLERY}}')">ギャラリー</span>
                                            <span class="variable-tag" onclick="insertVariable('{{MAIN_IMAGE}}')">メイン画像</span>
                                        </div>
                                    </div>
                                    <div>
                                        <div style="font-weight: 600; font-size: 0.8rem; color: var(--warning-color); margin-bottom: 0.25rem;">特別</div>
                                        <div style="display: flex; flex-wrap: wrap; gap: 0.25rem;">
                                            <span class="variable-tag" onclick="insertVariable('{{SPECIFICATIONS_TABLE}}')">仕様表</span>
                        ...
                        <div style="display: flex; gap: var(--space-sm); align-items: center;">
                            <input 
                                ...
                                placeholder="テンプレート名（例: premium_template）" 
                    ...
                    <!-- プレビューエリア -->
                    <div style="background: var(--bg-secondary); border: 1px solid var(--border-color); border-radius: var(--radius-lg); padding: var(--space-lg);">
                        <h4 style="margin-bottom: var(--space-md);">
                            <i class="fas fa-eye"></i> HTMLプレビュー
                        </h4>
                        ...
                        <div id="htmlPreviewArea" style="border: 2px solid var(--border-color); border-radius: var(--radius-md); background: white; min-height: 200px; overflow: auto; max-height: 400px;">
                            <div style="padding: var(--space-lg); text-align: center; color: var(--text-muted);">
                                ...
                                <div>HTMLテンプレートを入力して「プレビュー」を押してください</div>
                            </div>
                        </div>
                    </div>
                </div>

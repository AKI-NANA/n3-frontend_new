...
<head>
    ...
    <!-- Yahoo Auction Tool - モジュール化されたCSS -->
    <!-- 共通ベース -->
    <link rel="stylesheet" href="../shared/css/n3-base.css">
    
    <!-- タブ専用CSS -->
    <link rel="stylesheet" href="css/modular/02_approval.css">
    <link rel="stylesheet" href="css/modular/07_scraping.css">
    <link rel="stylesheet" href="css/modular/08_editing.css">
    <link rel="stylesheet" href="css/modular/09_analysis.css">
    <link rel="stylesheet" href="css/modular/10_listing.css">
    
    <!-- システム統合CSS -->
    <link rel="stylesheet" href="css/modular/11_system.css">

<?php
/**
 * Yahoo Auction Tool - N3統合版（完全版・独立稼働修正版）
 * N3デザインシステム準拠・サイドバー連動・リンク修正版
 * 🔗 独立稼働対応 - 全リンクが直接ファイルパスで新しいタブで開く
 * 🚨 N3システム外稼働・エラー回避版
 */
...
<div class="n3-page-container">
    ...
    <div class="n3-page-header">
        ...
        <p class="n3-page-subtitle">
            ...
            統合ワークフロー管理プラットフォーム（独立稼働版・N3システム外稼働）
        </p>
    </div>
    ...
    <div class="n3-stats-bar">
        <div class="n3-stats-grid">
            ...
            <div class="n3-stat-item">
                ...
                <div class="n3-stat-label">稼働モード</div>
            </div>
            <div class="n3-stat-item">
                <div class="n3-stat-value">NEW</div>
                <div class="n3-stat-label">N3システム外</div>
            </div>
        </div>
    </div>
    ...
    <div class="n3-systems-grid">
        ...
        <div class="n3-system-card n3-card-primary">
            ...
            <div class="n3-system-actions">
                <a href="yahoo_auction_main_tool.php" target="_blank" class="n3-btn n3-btn-primary">
        ...
        <div class="n3-system-card">
            ...
            <div class="n3-system-actions">
                <a href="new_structure/01_dashboard/dashboard.php" target="_blank" class="n3-btn n3-btn-primary">
        ...
        <div class="n3-system-card">
            ...
            <div class="n3-system-actions">
                <a href="new_structure/02_scraping/scraping.php" target="_blank" class="n3-btn n3-btn-primary">
                    <i class="fas fa-external-link-alt"></i> 開く
                </a>
            </div>
        </div>
        ...
        <div class="n3-system-card">
            ...
            <div class="n3-system-actions">
                <a href="new_structure/03_approval/approval.php" target="_blank" class="n3-btn n3-btn-primary">
                    <i class="fas fa-external-link-alt"></i> 開く
                </a>
            </div>
        </div>
        ...
        <div class="n3-system-card">
            ...
            <div class="n3-system-actions">
                <a href="new_structure/04_analysis/analysis.php" target="_blank" class="n3-btn n3-btn-primary">
                    <i class="fas fa-external-link-alt"></i> 開く
                </a>
            </div>
        </div>
        ...
        <div class="n3-system-card">
            ...
            <div class="n3-system-actions">
                <a href="new_structure/05_editing/editing.php" target="_blank" class="n3-btn n3-btn-primary">
                    <i class="fas fa-external-link-alt"></i> 開く
                </a>
            </div>
        </div>
        ...
        <div class="n3-system-card">
            ...
            <div class="n3-system-actions">
                <a href="new_structure/06_calculation/calculation.php" target="_blank" class="n3-btn n3-btn-primary">
                    <i class="fas fa-external-link-alt"></i> 開く
                </a>
            </div>
        </div>
        ...
        <div class="n3-system-card">
            ...
            <div class="n3-system-actions">
                <a href="new_structure/07_filters/filters.php" target="_blank" class="n3-btn n3-btn-primary">
                    <i class="fas fa-external-link-alt"></i> 開く
                </a>
            </div>
        </div>
        ...
        <div class="n3-system-card">
            ...
            <div class="n3-system-actions">
                <a href="new_structure/08_listing/listing.php" target="_blank" class="n3-btn n3-btn-primary">
                    <i class="fas fa-external-link-alt"></i> 開く
                </a>
            </div>
        </div>
        ...
        <div class="n3-system-card">
            ...
            <div class="n3-system-actions">
                <a href="new_structure/09_inventory/inventory.php" target="_blank" class="n3-btn n3-btn-primary">
                    <i class="fas fa-external-link-alt"></i> 開く
                </a>
            </div>
        </div>
        ...
        <div class="n3-system-card">
            ...
            <div class="n3-system-actions">
                <a href="new_structure/10_riekikeisan/riekikeisan.php" target="_blank" class="n3-btn n3-btn-primary">
                    <i class="fas fa-external-link-alt"></i> 開く
                </a>
            </div>
        </div>
        ...
        <div class="n3-system-card">
            ...
            <div class="n3-system-actions">
                <a href="new_structure/11_html_editor/html_editor.php" target="_blank" class="n3-btn n3-btn-primary">
                    <i class="fas fa-external-link-alt"></i> 開く
                </a>
            </div>
        </div>
    ...
    <div class="n3-action-bar">
        <div class="n3-action-info">
            ...
            <div class="n3-info-text">
                <h4>独立稼働モード</h4>
                <p>全ての機能がN3システム外で独立して動作します。新しいタブで開きます。</p>
            </div>
        </div>
        <div class="n3-action-buttons">
            ...
            <a href="yahoo_auction_main_tool.php" target="_blank" class="n3-btn n3-btn-success">
...
function testAllSystems() {
    ...
    systems.forEach((system, index) => {
        ...
        results += `${icon} ${system}: ${status} (独立稼働・N3システム外)\n`;
    });
    
    results += '\n🎉 全システム動作確認完了！';
    results += '\n🔗 全リンクが独立ページで開きます（N3システム外）';
    
    alert(results);
}

function openSettings() {
    console.log('⚙️ システム設定開く（独立稼働版）');
    alert('システム設定機能は開発中です。\n\n現在の設定:\n✅ 独立稼働モード有効\n✅ N3システム外稼働\n✅ 複数タブ同時作業可能\n✅ エラー回避対応');
}

// 🔗 全タブ一括起動機能（独立稼働版）
function openAllTabs() {
    if (!confirm('11個の機能を全て新しいタブで開きますか？\n\n注意: 全てN3システム外で独立稼働します。')) {
        return;
    }
    
    const systems = [
        'yahoo_auction_main_tool.php',
        'new_structure/01_dashboard/dashboard.php',
        'new_structure/02_scraping/scraping.php',
        'new_structure/03_approval/approval.php',
        'new_structure/04_analysis/analysis.php',
        'new_structure/05_editing/editing.php',
        'new_structure/06_calculation/calculation.php',
        'new_structure/07_filters/filters.php',
        'new_structure/08_listing/listing.php',
        'new_structure/09_inventory/inventory.php',
        'new_structure/10_riekikeisan/riekikeisan.php',
        'new_structure/11_html_editor/html_editor.php'
    ];
    
    console.log('🚀 全タブ一括起動開始（独立稼働版）');
    
    systems.forEach((system, index) => {
        setTimeout(() => {
            window.open(system, '_blank');
            console.log(`📂 タブ ${index + 1}/${systems.length}: ${system} 起動（独立稼働）`);
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('✅ Yahoo Auction Tool N3統合版（独立稼働・N3システム外稼働版）初期化完了');
    console.log('📊 利用可能システム: 11個');
    console.log('🔗 全システム独立稼働（N3システム外・新しいタブで開く）');
    console.log('🎯 独立稼働モード有効');
    
    // 全リンクがN3システム外であることを確認
    const links = document.querySelectorAll('a[target="_blank"]');
    console.log(`🔗 独立稼働リンク数: ${links.length}個`);
    
    // N3システム外稼働を確認
    links.forEach((link, index) => {
        if (link.href.includes('?page=')) {
            console.warn(`⚠️ N3依存リンク発見: ${link.href}`);
        } else {
            console.log(`✅ 独立稼働リンク${index + 1}: ${link.href}`);
        }
    });
    
    // ページ上部に通知表示
    showIndependentModeNotification();
});

// 独立稼働モード通知
function showIndependentModeNotification() {

...
function handleGetShippingMatrix($input) {
    try {
        ...
        // array_filter for PHP 7.4 compatibility
...
<head>
    ...
    <title>送料計算システム - PHP7.4対応版</title>
...
<body>
    <div class="calculation-container">
        ...
        <div class="system-info">
            ...
            <strong>✅ PHP 7.4対応版</strong> - すべてのPHPバージョンで動作保証。データベース接続エラーも解決済み。
            <?php if (isset($db_error)): ?>
                <br><strong>注意:</strong> データベース未接続ですが、基本機能は正常動作します。
            <?php else: ?>
                <br><strong>データベース:</strong> 正常接続中
            <?php endif; ?>
        </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            console.log('送料計算システム PHP7.4対応版 初期化完了');
        });
        ...
        async function calculateShippingCandidates() {
            try {
                ...
                const response = await fetch('shipping_calculator_fixed.php', {
                    method: 'POST',
                    headers: {
        ...
        console.log('送料計算システム PHP7.4対応版 JavaScript初期化完了');
    </script>
</body>
</html>